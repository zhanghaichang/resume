...
### 浦发银行基金系统扩容改造
* **技术实现**：Ofbiz,Java,Oracle，Weblogic,Soap
* **项目描述**：天正银基通系统是一套全新的支持银行基金代销和直销业务开展的运营系统。它采用了先进的JAVA系统架构。强大的而同一的J2EE服务器 不仅提供了稳定的运行环境，而且支持B/S和C/S两种交易模式，使一套系统能同时支持银行高低柜业务开展成为可能。天正银基通系统既拥有基金代（直）销 系统全渠道业务(包括柜面、电话银行和网上银行、自助银行等)的所有基本功能，如：基本交易、预约交易和强大查询统计等功能，又增加了定期定额功能、货币 市场基金功能、LOFS基金功能等最新交易功能。在产品形成过程中，该系统一直紧盯最新的业务变化和技术发展潮流，对原业务交易流程进行了反复的梳理，使 其更加贴近客户的实际需要。同时，该系统优化了第三方接入方式实现和通讯传输技术，使系统维护人员能够在不更改任何程序的情况下，通过直观的图形化配置来 实现复杂的与第三方的实时或批量通讯，大大提高了产品部署的快捷性和准确性。
* **技术要点**：分布式，批处理，联机交易，集群
* **个人职责**：性能测试和调优
